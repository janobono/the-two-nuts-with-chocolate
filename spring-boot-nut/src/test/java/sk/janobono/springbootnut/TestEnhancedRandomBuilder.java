...
public class TestEnhancedRandomBuilder {
    ...
    public static EnhancedRandom build() {
        return EnhancedRandomBuilder.aNewEnhancedRandomBuilder()
                .randomize(FieldPredicates.named("username").and(FieldPredicates.inClass(User.class).or(FieldPredicates.inClass(UserSO.class))), new FirstNameRandomizer())
                .randomize(FieldPredicates.named("email").and(FieldPredicates.inClass(User.class).or(FieldPredicates.inClass(UserSO.class))), new EmailRandomizer())
